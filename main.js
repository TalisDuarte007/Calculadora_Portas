...
// function nEmbutida(){
//     const medidaInterna = document.querySelector('.inputMedidaInterna').value;
//     const numeroDePortas = document.querySelector('.inputQuantidadePortas').value;

//     if (numeroDePortas = 1) {
        
//     }
//     else if (numeroDePortas = 2) {
...
//     document.querySelector('.resultado').innerHTML = teste;
// }